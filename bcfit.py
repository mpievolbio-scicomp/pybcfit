...
def meanVarAndNeutrals(neutralIndices,replicateReads,zCutoff,cycleTimes,firstPass = False):
    """
...
def inferFitnessAndError(allReads,allCycleTimes,multNoiseParams,neutralIndices,zCutoff,barcodes):
    """
